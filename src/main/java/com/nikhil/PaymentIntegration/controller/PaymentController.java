package com.nikhil.PaymentIntegration.controller;
...
import com.nikhil.PaymentIntegration.PaymentApplicationDetails.PaymentDetails;
...
public class PaymentController {
	...
	public String home() {
	 ...
	 @PostMapping(value = "/pgresponse")
	    public String getResponseRedirect(jakarta.servlet.http.HttpServletRequest request, Model model) {
